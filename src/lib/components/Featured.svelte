<div  class="p-4 md:w-1/3 sm:hidden">
	<div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
	  ...
	  <div class="p-6">
		...
		<h1 class="title-font text-lg font-medium text-gray-900 mb-3">  Machine desig </h1>
		<p class="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed.</p>
  ...
  <section class=" hidden sm:block w-full ">
	<div class="px-4 py-9 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24">
	  <div class="flex flex-wrap items-center mx-auto max-w-7xl">
		<div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
		  <div>
			<div class="relative w-full max-w-lg">
			  ...
			  <div class="relative">
				<img class="object-cover object-center mx-auto rounded-lg shadow-2xl w-96 h-96" alt="hero" src="https://images.unsplash.com/photo-1606337321936-02d1b1a4d5ef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80">
			  </div>
			</div>
		  </div>
		</div>
		<div class="flex flex-col items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
		  ...
		  <p class="mb-8 text-base leading-relaxed text-left text-gray-500">sub heading</p>
