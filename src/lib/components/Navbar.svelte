...
<div class=" sticky top-0 w-full bg-white backdrop-blur-lg bg-opacity-80  sm:bg-opacity-60 z-50">
	<div class="items-center justify-between sm:flex lg:justify-around">
		...
		<div class:hidden class="items-center sm:flex sm:gap-4 sm:pr-5">
			<a
				on:click={bawa}
				class="flex  gap-1 focus:outline-none hover:text-teal-500 justify-end items-center pr-6 text-right  text-base sm:pr-0"
				href="/"
			>
				Home
				<svg
			...
			<a
				on:click={bawa}
				class="flex  gap-1 focus:outline-none hover:text-teal-500 justify-end items-center pr-6 text-right  text-base md:text-xs lg:text-base sm:pr-0"
				href="/cta"
			>
				Work With Us
				<svg
